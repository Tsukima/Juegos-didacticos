...
export function teamScreen(){
  ...
  return `<div class="team-world"><section class="team-hero"><div><p class="eyebrow">Equipo Tinkie</p><h1>¿Cómo está tu motor hoy?</h1><p>Antes de empezar, mira tu semáforo interior. Cualquier color está bien.</p></div><div class="f1-car" aria-hidden="true">🏎️</div></section>
